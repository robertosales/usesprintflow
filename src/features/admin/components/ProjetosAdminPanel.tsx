...
export function ProjetosAdminPanel() {
  ...
  const openEdit   = (p: ProjetoAdmin) => {
    setForm({
      ...
      code:        p.code        || '',
      redmine_id:  p.redmine_id?.toString() || '',
    });
    setEditing(p);
    setShowForm(true);
  };
                    ...
                    <div className="space-y-1">
                      {p.contract_name && (
                        <div className="flex items-center gap-1.5 text-xs text-muted-foreground">
                          ...
                          <span className="truncate">{p.contract_name}</span>
                        </div>
                      )}
                      {p.team_name && (
                        <button
      ...
      <Dialog open={showForm} onOpenChange={o => !o && setShowForm(false)}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Vincule o projeto a um contrato e, opcionalmente, a uma sala.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-3 py-1">
            ...
            <div className="space-y-1.5">
              ...
              <Select
                ...
                onValueChange={v => setForm(p => ({ ...p, contract_id: v, team_id: '' }))}
              >
            ...
            <div className="space-y-1.5">
              ...
              <Select
                ...
                onValueChange={v => setForm(p => ({ ...p, team_id: v === 'none' ? '' : v }))}
              >
