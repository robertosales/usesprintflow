    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap gap-2">
        <div className="relative flex-1 min-w-[200px]">
          ...
          <Input placeholder="Buscar RHM ou projeto..." value={search} onChange={e => setSearch(e.target.value)} className="pl-9 h-9" />
        </div>
        ...
        {projetos.length > 0 && (
          <Select value={filterProjeto} onValueChange={setFilterProjeto}>
            <SelectTrigger className="w-[160px] h-9"><SelectValue placeholder="Projeto" /></SelectTrigger>
            <SelectContent>
              <SelectItem value="all">Todos</SelectItem>
            ...
            >
              <div className="rounded-lg bg-muted/40 border p-2 h-full">
                <div className="flex items-center justify-between mb-2 px-1">
                  ...
                  <Badge variant="secondary" className="text-[10px] h-4 min-w-4 flex items-center justify-center">{items.length}</Badge>
                </div>
