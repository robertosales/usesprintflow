...
const Auth = () => {
  ...
  const handleGoogleLogin = async () => {
    setLoading(true);
    // ✅ Usa supabase.auth diretamente — redirectTo aponta para /auth/callback
    // que processa o code PKCE e estabelece a sessão antes de redirecionar.
    ...
    // Não resetamos loading aqui pois o browser vai ser redirecionado
  };
