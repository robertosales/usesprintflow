-- ============================================================
-- MIGRATION: Fase 2 — user_contracts + RLS + backfill
-- Data: 2026-06-10
-- NOTA: enum 'admin_contrato' já foi adicionado manualmente.
--       Este arquivo contém apenas o restante da Fase 2.
-- ============================================================
...
-- ============================================================
-- 6. handle_new_user — novos usuários já entram vinculados
-- ============================================================
